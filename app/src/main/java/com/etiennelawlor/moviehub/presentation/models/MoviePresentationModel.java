...
public class MoviePresentationModel implements Parcelable {
    ...
    // region Constructors
    public MoviePresentationModel() {
    }

    protected MoviePresentationModel(Parcel in) {
    ...
    public static final Creator<MoviePresentationModel> CREATOR = new Creator<MoviePresentationModel>() {
        @Override
        public MoviePresentationModel createFromParcel(Parcel source) {
            return new MoviePresentationModel(source);
        }

        @Override
        public MoviePresentationModel[] newArray(int size) {
            return new MoviePresentationModel[size];
        }
    };
