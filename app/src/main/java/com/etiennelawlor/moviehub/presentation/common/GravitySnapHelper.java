package com.etiennelawlor.moviehub.presentation.common;

/**
 * Created by etiennelawlor on 8/31/16.
 */
...
public class GravitySnapHelper extends SnapHelper {
    ...
    public GravitySnapHelper(int gravity, boolean enableSnapLastItem) {
        ...
        this.snapLastItemEnabled = enableSnapLastItem;
    }
    // endregion
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView)
        ...
        if (recyclerView != null && (gravity == Gravity.START || gravity == Gravity.END)) {
            isRtlHorizontal
    ...
    private View findStartView(RecyclerView.LayoutManager layoutManager,
        ...
        if (layoutManager instanceof LinearLayoutManager) {
            ...
            if (visibleWidth > 0.5f) {
                ...
                if (snapLastItemEnabled && endOfList) {
                    return child;
                }
    ...
    private View findEndView(RecyclerView.LayoutManager layoutManager,
        ...
        if (layoutManager instanceof LinearLayoutManager) {
            ...
            if (visibleWidth > 0.5f) {
                ...
                if (snapLastItemEnabled && startOfList) {
                    return child;
                }
